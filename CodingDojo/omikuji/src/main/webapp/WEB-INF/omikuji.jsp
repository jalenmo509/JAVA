                    ...
                    <p>In <c:out value="${number}"></c:out>
                      years, you will live in <%String city=(String)session.getAttribute("city");out.print(city);%> with
                        <%String name=(String)session.getAttribute("name");out.print(name);%> as your roommate,
                          <%String hobby=(String)session.getAttribute("hobby");out.print(hobby);%> for a living. The
                            next time you see a
                            <%String living=(String)session.getAttribute("living");out.print(living);%>, you will have
                              good luck. Also,
                              <%String nice=(String)session.getAttribute("nice");out.print(nice);%>
                    </p>
                  </div>
